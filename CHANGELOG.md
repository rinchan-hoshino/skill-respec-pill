...
- Restore the visible, clickable **Reset Page** button on Puffish Skills 0.18.3 screens, whose custom render-state and mouse-input methods bypass vanilla screen widgets.
